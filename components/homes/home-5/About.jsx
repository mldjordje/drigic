        ...
        <div className="row align-items-center justify-content-end">
          <div className="col-lg-6">
            <div className="overflow-hidden">
              <div className="about-content-wrap fade_right glass-panel">
                <div className="title-area mb-0">
                  ...
                  <h5 className="text-smoke mb-2">Preciznost i sigurnost svakog tretmana</h5>
                  <h5 className="text-smoke mb-2">Individualni plan za svako lice</h5>
                  <h5 className="text-smoke mb-0">Prirodni rezultati i dugoročna harmonija</h5>
                  <div className="btn-wrap mt-50 d-flex align-items-center gap-3">
                    <Link scroll={false} href="#konsultacije" className="link-btn text-theme">
