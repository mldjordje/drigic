...
const envSchema = z.object({
  ...
  RESEND_FROM: z
    .string()
    .min(3)
    .default("Dr Igic Clinic <obavestenja@drigic.rs>"),
  RESEND_REPLY_TO: z.string().email().default("drigicclinic@gmail.com"),
  RESEND_DAILY_LIMIT: z.coerce.number().int().min(1).max(50000).default(100),
  ADMIN_BOOKING_NOTIFY_EMAIL: z
    .string()
    .email()
    .default("drigicclinic@gmail.com"),
  ...
  CLINIC_BOOKING_WINDOW_DAYS: z.coerce.number().int().min(1).default(31),
});
