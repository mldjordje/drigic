...
describe("admin navigation", () => {
  ...
  it("prefers the most-specific boundary-valid route from custom groups", () => {
    const groups = [
      {
        labelKey: "admin.groups.clients",
        items: [
          { href: "/admin/clients", labelKey: "admin.clients" },
          { href: "/admin/clients/vip", labelKey: "admin.vip" },
        ],
      },
    ];

    expect(
      resolveAdminNavigationItem("/admin/clients/vip/123", groups)?.href
    ).toBe("/admin/clients/vip");
  });
});
