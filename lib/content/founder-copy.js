const FOUNDER_COPY = {
  sr: {
    ...
    summary:
      "Sertifikovani lekar estetske i anti-age medicine, sa jasnom vizijom prirodnih, suptilnih i harmoničnih rezultata koji prate individualnu anatomiju svakog pacijenta.",
    paragraphs: [
      "Trenutno je na specijalizaciji iz plastične, rekonstruktivne i estetske hirurgije, gde dodatno usavršava svoje znanje i veštine.",
      "U svom radu teži da spoji medicinsku preciznost, estetski osećaj i savremene tehnike, sa fokusom na sigurnost i dugoročno zadovoljstvo pacijenata. Veruje da je najlepši rezultat onaj koji ne menja ličnost, već naglašava prirodnu lepotu.",
      "Kontinuirana edukacija je važan deo profesionalnog razvoja. Redovno pohađa kongrese, radionice i treninge kako u Srbiji, tako i širom sveta, prateći najnovije trendove i standarde u estetskoj medicini.",
      "Pristup svakom pacijentu je individualan, iskren i posvećen, jer svaki pacijent zaslužuje pažnju, razumevanje i vrhunski rezultat.",
    ],
    highlights: [
