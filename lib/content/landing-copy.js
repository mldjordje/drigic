...
const LANDING_COPY = {
  "hijaluronski-fileri": {
    ...
    // Odredište oglasa: forma za zakazivanje nabraja ceo katalog usluga, pa je
    // i ovde naziv leka morao da nestane sa stranice.
    neutralNames: true,
  ...
  "mimicne-bore": {
    ...
    // Odredište oglasa: i forma za zakazivanje ide bez naziva leka.
    neutralNames: true,
    eyebrow: "Niš · Cvijićeva 31/3",
