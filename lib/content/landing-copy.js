...
export const LANDING_KEYS = ["hijaluronski-fileri", "botox", "estetska-medicina"];
...
const LANDING_COPY = {
  ...
  "estetska-medicina": {
    ...
    h1Accent: "medicina",
    lead:
      "Ordinacija dr Nikole Igića u centru Niša. Fileri, botoks, skinbusteri, PRP i mezoterapija — bez operacije. Konsultacija je besplatna i ne obavezuje na tretman.",
    heroImage: "/assets/img/doctor-about.webp",
    heroImageAlt: "Dr Nikola Igić, lekar estetske medicine, Dr Igić Clinic Niš",
    heroFacts: [
    ...
    derisk: [
      ...
      },
      {
        ...
        text: "Hijaluronski fileri se razgrađuju i mogu se rastvoriti enzimom. Botoks popušta za 3 do 5 meseci.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Hijaluronski fileri, botoks, skinbusteri, kolagen stimulatori, polinukleotidi i egzozomi, lipoliza, hemijski piling, dermapen, PRP i mezoterapija.",
      },
      {
        q: "Da li tretmani bole?",
        a: "Kod filera se koristi anestetička krema, a sam gel sadrži lidokain. Botoks se radi ultratankom iglom, bez anestezije.",
      },
      {
    ...
    metaDescription:
      "Ordinacija estetske medicine u Nišu — fileri, botoks, PRP, mezoterapija. Radi lekar dr Nikola Igić. Besplatna konsultacija, Cvijićeva 31/3, pon–pet 16–21.",
  },
};
